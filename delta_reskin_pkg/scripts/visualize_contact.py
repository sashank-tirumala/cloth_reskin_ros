...
def create_video_array(bagfile, data_arr, CUTOFF, PTS_PLOTTED=250, verbose=False):
    ...
    for topic, msg, t in bagfile.read_messages(topics=["/webcam_image"]):
        if topic == "/webcam_image":
            ...
            earliest_index = (
                nearest_greater_index - PTS_PLOTTED
                if nearest_greater_index - PTS_PLOTTED > 0
                else 0
            )
...
if __name__ == "__main__":
    ...
    video = cv2.VideoWriter(
        "/home/sashank/catkin_ws/src/tactilecloth/videos/test_contact.avi",
        fourcc,
        10,
        (width, height),
    )
